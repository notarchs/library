...
local SolarisLib = {
    Themes = {
        ...
        Darker = {
            MainFrame = Color3.fromRGB(16,16,16),
            TopBar = Color3.fromRGB(4,4,4),
            TextColor =  Color3.fromRGB(255,255,255),
            Menu = Color3.fromRGB(8,8,8),
...
function SolarisLib:New(Config)
    ...
    function SettingsConstructor()
        ...
        general:ToggleSetting("Show Music On Launch", "Shows the music menu when you load Archs ken script :P", true, "ShowMusicOnLaunch")
        ...
        appearance:Dropdown("Theme", "The look of the user interface", {"Default", "Darker", "Discord", "Red", "Green", "Blue"}, "Default", "Theme")
